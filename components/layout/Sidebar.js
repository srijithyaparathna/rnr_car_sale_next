            ...
            <div className="sidebar-dashboard">
                ...
                <div className="db-menu">
                    <ul>
                        ...
                        <li className={pathname == "/vehicleType" ? "active" : ""}>
                            <Link href="/page/admin/type/list-main-types">
                                <div className="icon">
                                    <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.99167 14.4493L1.85 9.67435L0.5 10.7243L8 16.5577L15.5 10.7243L14.1417 9.66602L7.99167 14.4493ZM8 12.3327L14.1333 7.55768L15.5 6.49935L8 0.666016L0.5 6.49935L1.85833 7.55768L8 12.3327Z" fill="#D01818" />
                                    </svg>
                        ...
                        <li className={pathname == "/vehicleType" ? "active" : ""}>
                            <Link href="/page/admin/type/list-sub-types">
                                <div className="icon">
                                    <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.99167 14.4493L1.85 9.67435L0.5 10.7243L8 16.5577L15.5 10.7243L14.1417 9.66602L7.99167 14.4493ZM8 12.3327L14.1333 7.55768L15.5 6.49935L8 0.666016L0.5 6.49935L1.85833 7.55768L8 12.3327Z" fill="#D01818" />
                                    </svg>
                        ...
                        <li className={pathname == "/vehicleType" ? "active" : ""}>
                            <Link href="/page/admin/type/add-main-type">
                                <div className="icon">
                                    <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.99167 14.4493L1.85 9.67435L0.5 10.7243L8 16.5577L15.5 10.7243L14.1417 9.66602L7.99167 14.4493ZM8 12.3327L14.1333 7.55768L15.5 6.49935L8 0.666016L0.5 6.49935L1.85833 7.55768L8 12.3327Z" fill="#D01818" />
                                    </svg>
                                </div>
                                <p>Add Main Vehicle Type</p>
                            </Link>
                        </li>
